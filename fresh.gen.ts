...
import * as $api_v0_asset_assetId_ from "./routes/api/v0/asset/[assetId].ts";
...
import * as $api_v0_user_username_ from "./routes/api/v0/user/[username].ts";
import * as $api_v0_user_username_assets from "./routes/api/v0/user/[username]/assets.ts";
import * as $api_v0_user_username_file_filename_ from "./routes/api/v0/user/[username]/file/[filename].ts";
import * as $api_v0_user_username_files from "./routes/api/v0/user/[username]/files.ts";
import * as $asset_assetId_ from "./routes/asset/[assetId].tsx";
...
const manifest = {
  routes: {
    ...
    "./routes/api/v0/asset/[assetId].ts": $api_v0_asset_assetId_,
    ...
    "./routes/api/v0/user/[username].ts": $api_v0_user_username_,
    "./routes/api/v0/user/[username]/assets.ts": $api_v0_user_username_assets,
    "./routes/api/v0/user/[username]/file/[filename].ts":
      $api_v0_user_username_file_filename_,
    "./routes/api/v0/user/[username]/files.ts": $api_v0_user_username_files,
    "./routes/asset/[assetId].tsx": $asset_assetId_,
